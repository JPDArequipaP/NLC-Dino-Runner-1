...
class Game:
    ...
    def print_menu_elements(self, death_count=0):
        ...
        if death_count > 0:
            text, text_rect = get_centered_message('Press any key to Restart the game')
            death, death_rect = get_centered_message('Death count: {}'.format(death_count),
                                                     half_screen_width+20, half_screen_height+45)
